    ...
    const mockOrder: Order = {
      ...
      products: [
        ...
        },
        {
          ...
          price: 75000,
          image:
            "https://media.karousell.com/media/photos/products/2024/11/12/buku_sapiens__yuval_noah_harar_1731400061_d3a7738d_progressive.jpg",
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center space-x-2">
          <BackButton fallbackUrl="/dashboard/orders" />
        </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center">
            ...
            <span className="ml-2">
              Status Pesanan: {getStatusText(order.status)}
            </span>
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="relative">
            <div className="flex items-center mb-8">
              ...
              >
                <div
                  className={`rounded-full p-2 ${
                    order.status === "delivered" ? "bg-blue-100" : "bg-gray-100"
                  }`}
                >
          ...
          {order.status === "shipped" && (
            <div className="mt-6 p-4 bg-blue-50 rounded-lg">
              ...
              <p className="text-sm">
                Pesanan Anda sedang dalam perjalanan. Nomor resi:{" "}
          ...
          {order.status === "cancelled" && (
            <div className="mt-6 p-4 bg-red-50 rounded-lg">
              ...
              <p className="text-sm">
                Pesanan ini telah dibatalkan. Jika Anda sudah melakukan
                pembayaran, dana akan dikembalikan dalam 3-5 hari kerja.
              </p>
            </div>
          )}
        </CardContent>
            ...
            <div className="space-y-3">
              ...
              {order.payment.date && (
                <div>
                  ...
                  <p className="text-sm">
                    {new Date(order.payment.date).toLocaleDateString("id-ID")}
                  </p>
                </div>
              )}
              <Separator />
